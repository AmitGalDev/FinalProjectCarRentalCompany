...
namespace CarsApp.Controllers
{
        ...
        ////GET: api/Cars
        //[HttpGet]
        //public IHttpActionResult GetAvaliableCars()
        //{
        //    using (CarsDBEntities db = new CarsDBEntities())
        //    {
        //        List<CarsTable> ct = new List<CarsTable>();
        //        foreach (var i in db.CarsTables)
        //        {
        //            if (i.isDamaged == false && i.isRentable == true)
        //            {
        //                ct.Add(i);
        //            }
        //        }
        ...
        public IHttpActionResult GetAllCars()
        {
            using (CarsDBEntities db = new CarsDBEntities())
            {
                return Ok(db.CarsTables.ToList());
            }
        }
        ...
        public IHttpActionResult Delete(int caridnumber)
        {
            using (CarsDBEntities db = new CarsDBEntities())
            {
                var CurrentCar = db.CarsTables.FirstOrDefault(tmpcar => tmpcar.CarID == caridnumber);
                if (CurrentCar != null)
                {
                    db.CarsTables.Remove(CurrentCar);
                    db.SaveChanges();
